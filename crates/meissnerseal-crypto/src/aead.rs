...
// Allows meissnerseal-core to wrap ciphertext bytes loaded from the vault file
...
mod tests {
    ...
    // "meissnerseal-aad-v1" (19) + vault_id (16) + 5×u16 (10) + record_id (16) + revision_id (16) + kind (2) = 79
    const AAD: [u8; 79] = [
    ...
    const EXPECTED_CIPHERTEXT_WITHOUT_TAG: [u8; 36] = [
        ...
        0x61, 0x31, 0xa7, 0x73, 0x26, 0x6f,
    ];
    const EXPECTED_TAG: [u8; 16] = [
        0xa4, 0x6b, 0xab, 0x7d, 0xef, 0x47, 0xf6, 0x4e, 0xd1, 0xb1, 0x39, 0x3d, 0xd2, 0x24, 0xf3,
        0x83,
    ];
    const EXPECTED_CIPHERTEXT_TAG: [u8; 52] = [
        0x33, 0xce, 0x44, 0xa7, 0x1d, 0xb8, 0x13, 0x1d, 0xa9, 0x12, 0xd3, 0x0f, 0x5e, 0x8b, 0x57,
        0x8c, 0x48, 0x26, 0xe9, 0xb0, 0x53, 0x92, 0xf2, 0x39, 0x81, 0x34, 0x2a, 0xc4, 0x6e, 0x9e,
        0x61, 0x31, 0xa7, 0x73, 0x26, 0x6f, 0xa4, 0x6b, 0xab, 0x7d, 0xef, 0x47, 0xf6, 0x4e, 0xd1,
        0xb1, 0x39, 0x3d, 0xd2, 0x24, 0xf3, 0x83,
    ];
