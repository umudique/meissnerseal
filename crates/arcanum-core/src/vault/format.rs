...
///   `arcanum-crypto` HKDF subkey derivation (`crypto_design.md` §5).
...
///
/// ## Invariants
/// - Uses `arcanum-crypto` AEAD only; this crate never implements cryptography
///   directly.
...
///
/// ## Invariants
/// - Uses `arcanum-crypto` AEAD only; no direct cryptographic primitive calls.
